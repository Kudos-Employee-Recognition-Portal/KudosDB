...
VALUES
(2,'Employee of the Month','Joe Something','Joe.Something@test.com',11),
(1,'Award 2','Samantha','Samantha.Enlish@test.com',12),
(3,'Award 3','Asia Knox','Asia.Knox@test.com',13),
(1,'Award 4','Dalia Durham','Dalia.Durham@test.com',14),
(1,'Award 5','Jobe Wilcox','Jobe.Wilcox@test.com',15),
(1,'Award 6','Usama Bowman','Usama.Bowman@test.com',16),
(2,'Award 7','Hamza Marks','Hamza.Marks@test.com',17),
(2,'Award 8','Wiktoria Miles','Wiktoria.Miles@test.com',18),
(3,'Award 9','Marjorie Hobbs','Marjorie.Hobbs@test.com',19),
(1,'Award 10','Jonathan Cartwright','Jonathan.Cartwright@test.com',20),
(1,'Award 11','Fiza Atkinson','Fiza.Atkinson@test.com',21),
(1,'Award 12','Jimi English','Jimi.English@test.com',22),
(1,'Award 13','Lucy Rojas','Lucy.Rojas@test.com',23),
(1,'Award 14','Nuha Shepherd','Nuha.Shepherd@test.com',24),
(2,'Award 15','Remy Frazier','Remy.Frazier@test.com',25),
(1,'Award 16','Reyansh Rivera','Reyansh.Rivera@test.com',26),
(2,'Award 17','Brayden Mitchell','Brayden.Mitchell@test.com',27),
(3,'Award 18','Ammaarah Mercer','Ammaarah.Mercer@test.com',28),
(1,'Award 19','Hareem Hicks','Hareem.Hicks@test.com',29),
(1,'Award 20','Oliwia Wynn','Oliwia.Wynn@test.com',30),
(1,'Award 21','Bibi Ellis','Bibi.Ellis@test.com',31),
(3,'Award 22','Ruben Pollard','Ruben.Pollard@test.com',32);
